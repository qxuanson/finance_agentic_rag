...
chroma_client = Chroma(persist_directory="D:/agentic_rag_finance/index_chromadb")
collection_name = "index"
all_chunked_documents = pickle.load(open("D:/agentic_rag_finance/chunked_documents_index.pkl", "rb"))
...
ensemble_retriever = EnsembleRetriever(retrievers=[vectorstore_retreiver,
                                                   keyword_retriever],
                                       weights=[0.3, 0.7])
def rag_index(query_text, ensemble_retriever):
